<script lang="ts">
  import liu_logo_black from '$lib/assets/LiU-Black_Liu_noText.svg';
  import liu_logo_white from '$lib/assets/LiU-White_Liu_noText.svg';
...
<ul class="flex min-h-full w-14 flex-col items-center gap-4 bg-gray-100 dark:bg-gray-900">
  <li
  ...
  >
    <DifferingSpeedLink to="/">
      <img src={liu_logo_black} alt="LiU logo" class="h-6 w-6 dark:hidden" />
      <img src={liu_logo_white} alt="LiU logo" class="hidden h-6 w-6 dark:block" />
    </DifferingSpeedLink>
  </li>
  <li
    class="flex h-12 w-14 items-center justify-center hover:cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700"
